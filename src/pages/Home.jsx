      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto px-4">
          ...
          >
            ...
            creating beautiful and functional web applications. Explore my work
            and let's build something amazing together.
          </motion.p>

          {/* btn */}
          <div className="flex justify-center xl:hidden relative z-10 mb-8">
            <ProjectsBtn />
          </div>
          <motion.div
